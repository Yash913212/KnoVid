...
const VARIANTS: Record<Variant, string> = {
  primary:
    'sheen-button bg-[#586BE3] text-white shadow-[0_10px_30px_rgb(88_107_227/0.24)] ring-1 ring-[#8793F2]/60 hover:-translate-y-0.5 hover:bg-[#7181F0] hover:shadow-[0_16px_44px_rgb(88_107_227/0.36)] active:scale-[0.985]',
  secondary:
    'border border-black/[0.1] bg-white/70 text-stone-700 shadow-panel backdrop-blur-xl hover:border-[#586BE3]/70 hover:text-stone-950 dark:border-white/15 dark:bg-white/[0.05] dark:text-stone-200 dark:hover:border-[#8793F2]/70 dark:hover:text-[#B8C1FF]',
  ghost:
